...
clairDS_A = getSubset(clairDS,
                      startAnalysisYear,
                      startAnalysisMonth,
                      endAnalysisYear,
                      endAnalysisMonth)

clairPrecip_A = getSubset(
  clairPrecip,
  startAnalysisYear,
  startAnalysisMonth,
  endAnalysisYear,
...
clairNBS_A = getSubset(clairNBS,
                       startAnalysisYear,
                       startAnalysisMonth,
                       endAnalysisYear,
                       endAnalysisMonth)

clairOutflow_A = getSubset(
  clairOutflow,
  startAnalysisYear,
  startAnalysisMonth,
  endAnalysisYear,
...
erieDS_A = getSubset(erieDS,
                     startAnalysisYear,
                     startAnalysisMonth,
                     endAnalysisYear,
                     endAnalysisMonth)

erieOutflow_A = getSubset(
  erieOutflow,
  startAnalysisYear,
  startAnalysisMonth,
  endAnalysisYear,
...
erieEvap_A = getSubset(erieEvap,
                       startAnalysisYear,
                       startAnalysisMonth,
                       endAnalysisYear,
                       endAnalysisMonth)
erieRunoff_A = getSubset(
  erieRunoff,
  startAnalysisYear,
  startAnalysisMonth,
  endAnalysisYear,
...
erieNBS_A = getSubset(erieNBS,
                      startAnalysisYear,
                      startAnalysisMonth,
                      endAnalysisYear,
                      endAnalysisMonth)

ontarioDS_A = getSubset(
  ontarioDS,
  startAnalysisYear,
  startAnalysisMonth,
  endAnalysisYear,
...
for (startMo in seq(posteriorStartMonth, posteriorEndMonth, 120)) {
  ...
  pdf(
    paste('superiorTS_Preview_d', decade, '_', modelName, '.pdf', sep = ''),
    width = 10,
    height = 7.5
  )
  ...
  for (i in startMo:endMo) {
    lines(
      c(i, i + 1),
      c(ySuperiorOutflow1[i], ySuperiorOutflow1[i]),
      col = "darkgreen",
      lwd = 1.5,
      type = 's'
    )
    lines(
      c(i, i + 1),
      c(ySuperiorOutflow2[i], ySuperiorOutflow2[i]),
      col = "purple",
      lwd = 1.5,
      type = 's'
    )
  ...
  for (i in startMo:endMo) {
    lines(
      c(i, i + 1),
      c(ySuperiorDiversion1[i], ySuperiorDiversion1[i]),
      col = "darkgreen",
      lwd = 1.5,
      type = 's'
    )
  ...
  pdf(
    paste('miHuronTS_Preview_d', decade, '_', modelName, '.pdf', sep = ''),
    width = 10,
    height = 7.5
  )
  ...
  for (i in startMo:endMo) {
    lines(
      c(i, i + 1),
      c(yMiHuronOutflow1[i], yMiHuronOutflow1[i]),
      col = "darkgreen",
      lwd = 1.5,
      type = 's'
    )
    lines(
      c(i, i + 1),
      c(yMiHuronOutflow2[i], yMiHuronOutflow2[i]),
      col = "purple",
      lwd = 1.5,
      type = 's'
    )
  ...
  for (i in startMo:endMo) {
    lines(
      c(i, i + 1),
      c(yMiHuronDiversion1[i], yMiHuronDiversion1[i]),
      col = "darkgreen",
      lwd = 1.5,
      type = 's'
    )
  ...
  pdf(
    paste('clairTS_Preview_d', decade, '_', modelName, '.pdf', sep = ''),
    width = 10,
    height = 7.5
  )
  ...
  for (i in startMo:endMo) {
    lines(
      c(i, i + 1),
      c(yClairOutflow1[i], yClairOutflow1[i]),
      col = "darkgreen",
      lwd = 1.5,
      type = 's'
    )
    lines(
      c(i, i + 1),
      c(yClairOutflow2[i], yClairOutflow2[i]),
      col = "purple",
      lwd = 1.5,
      type = 's'
    )
  ...
  # LMF 2019-06-18 fix x-axis
  mtext(expression(paste(Delta, 'H (cms)')),
        side = 2,
        line = 2.5,
        cex = 0.8)
  ...
  pdf(
    paste('erieTS_Preview_d', decade, '_', modelName, '.pdf', sep = ''),
    width = 10,
    height = 7.5
  )
  ...
  for (i in startMo:endMo) {
    lines(
      c(i, i + 1),
      c(yErieOutflow1[i], yErieOutflow1[i]),
      col = "darkgreen",
      lwd = 1.5,
      type = 's'
    )
  ...
  for (i in startMo:endMo) {
    lines(
      c(i, i + 1),
      c(yErieDiversion1[i], yErieDiversion1[i]),
      col = "darkgreen",
      lwd = 1.5,
      type = 's'
    )
  ...
  pdf(
    paste('ontarioTS_Preview_d', decade, '_', modelName, '.pdf', sep = ''),
    width = 10,
    height = 7.5
  )
  ...
  for (i in startMo:endMo) {
    lines(
      c(i, i + 1),
      c(yOntarioOutflow1[i], yOntarioOutflow1[i]),
      col = "darkgreen",
      lwd = 1.5,
      type = 's'
    )
