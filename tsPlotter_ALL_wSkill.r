...
for (startMo in seq(posteriorStartMonth, posteriorEndMonth, 120)) {
  ...
  if(endMoPlot > posteriorEndMonth) break;
  ...
  yearRange = (startAnalysisYear + (decade * 10)):(startAnalysisYear + ((decade +
                                                                           1) * 10) - 1)
  ...
  startNew <-
    as.Date(paste(startAnalysisYear, startAnalysisMonth, 15, sep = "-"))
  library(lubridate)
  
  month(startNew) = month(startNew) + startMo - 1
  
  endNew <-
    as.Date(paste(startAnalysisYear, startAnalysisMonth, 15, sep = "-"))
  # as.Date(paste(endAnalysisYear, endAnalysisMonth, 15, sep = "-"))
  
  month(endNew) = month(endNew) + endMo - 1
  ...
  pdf(
    paste('superiorTS_ALL_d', decade, '_', modelName, '.pdf', sep = ''),
    width = 10,
    height = 7.5
  )
  ...
  if (superiorComponentWBM) {
    ...
    axis(
      1,
      at = seq(startMo, endMoPlot, 6),
      labels = FALSE,
      las = 2
    )
    # LMF 2019-06-18 fix for x-axis
    ...
    for (i in startMo:endMo) {
      ...
      for (n in 3:ncol(superiorPrecip_A)) {
        lines(
          c(i, i + 1),
          c(superiorPrecip_A[i, n], superiorPrecip_A[i, n]),
          col = colorVector[n - 2],
          lwd = 1.5,
          type = 's'
        )
        
        modelSkillPoints[[paste0('superiorPrecip', superiorPrecipSrc[n - 2])]] = c(modelSkillPoints[[paste0('superiorPrecip', superiorPrecipSrc[n -
                                                                                                                                                  2])]],
    ...
    legend(
      ...
      bty = 'n',
      lty = c(0, rep(1, length(
        superiorPrecipSrc
      ))),
      lwd = c(0, rep(1.5, length(
        superiorPrecipSrc
      ))),
      pch = c(15, rep(NA, length(
        superiorPrecipSrc
      ))),
      ncol = 5
    )
    ...
    for (i in startMo:endMo) {
      ...
      for (n in 3:ncol(superiorEvap_A)) {
        lines(
          c(i, i + 1),
          c(superiorEvap_A[i, n], superiorEvap_A[i, n]),
          col = colorVector[n - 2],
          lwd = 1.5,
          type = 's'
        )
        
        modelSkillPoints[[paste0('superiorEvap', superiorEvapSrc[n - 2])]] = c(modelSkillPoints[[paste0('superiorEvap', superiorEvapSrc[n -
                                                                                                                                          2])]],
    ...
    for (i in startMo:endMo) {
      ...
      for (n in 3:ncol(superiorRunoff_A)) {
        lines(
          c(i, i + 1),
          c(superiorRunoff_A[i, n], superiorRunoff_A[i, n]),
          col = colorVector[n - 2],
          lwd = 1.5,
          type = 's'
        )
        
        modelSkillPoints[[paste0('superiorRunoff', superiorRunoffSrc[n - 2])]] = c(modelSkillPoints[[paste0('superiorRunoff', superiorRunoffSrc[n -
                                                                                                                                                  2])]],
    ...
    for (i in startMo:endMo) {
      ...
      for (n in 3:ncol(superiorNBS_A)) {
        lines(
          c(i, i + 1),
          c(superiorNBS_A[i, n], superiorNBS_A[i, n]),
          col = colorVector[n - 2],
          lwd = 1.5,
          type = 's'
        )
        
        modelSkillPoints[[paste0('superiorNBS', superiorNBSSrc[n - 2])]] = c(modelSkillPoints[[paste0('superiorNBS', superiorNBSSrc[n -
                                                                                                                                      2])]],
  ...
  for (i in startMo:endMo) {
    ...
    for (n in 3:ncol(superiorOutflow_A)) {
      lines(
        c(i, i + 1),
        c(superiorOutflow_A[i, n], superiorOutflow_A[i, n]),
        col = colorVector[n - 2],
        lwd = 1.5,
        type = 's'
      )
      
      modelSkillPoints[[paste0('superiorOutflow', superiorOutflowSrc[n - 2])]] = c(modelSkillPoints[[paste0('superiorOutflow', superiorOutflowSrc[n -
                                                                                                                                                    2])]],
  ...
  for (i in startMo:endMo) {
    ...
    for (n in 3:ncol(superiorDiversion_A)) {
      lines(
        c(i, i + 1),
        c(superiorDiversion_A[i, n], superiorDiversion_A[i, n]),
        col = colorVector[n - 2],
        lwd = 1.5,
        type = 's'
      )
      
      modelSkillPoints[[paste0('superiorDiversion', superiorDiversionSrc[n -
                                                                           2])]] = c(modelSkillPoints[[paste0('superiorDiversion', superiorDiversionSrc[n -
                                                                                                                                                          2])]],
  ...
  axis(
    1,
    at = seq(startMo, endMoPlot, 6),
    labels = format(seq(startNew, endNew, by = "6 months"), '%b %y'),
    las = 2
  )
  # LMF 2019-06-18 x-axis fix
  mtext(expression(paste(Delta, 'H (mm)')),
        side = 2,
        line = 2.5,
        cex = 0.8)
  ...
  for (i in startMo:endMo) {
    ...
    lines(
      c(i, i + 1),
      c(superiorDS_A[i, 3], superiorDS_A[i, 3]),
      col = "goldenrod",
      lwd = 1.5,
      type = 's'
    )
  ...
  pdf(
    paste('miHuronTS_ALL_d', decade, '_', modelName, '.pdf', sep = ''),
    width = 10,
    height = 7.5
  )
  ...
  if (miHuronComponentWBM) {
    ...
    for (i in startMo:endMo) {
      ...
      for (n in 3:ncol(miHuronPrecip_A)) {
        lines(
          c(i, i + 1),
          c(miHuronPrecip_A[i, n], miHuronPrecip_A[i, n]),
          col = colorVector[n - 2],
          lwd = 1.5,
          type = 's'
        )
        
        modelSkillPoints[[paste0('miHuronPrecip', miHuronPrecipSrc[n - 2])]] = c(modelSkillPoints[[paste0('miHuronPrecip', miHuronPrecipSrc[n -
                                                                                                                                              2])]],
    ...
    for (i in startMo:endMo) {
      ...
      for (n in 3:ncol(miHuronEvap_A)) {
        lines(
          c(i, i + 1),
          c(miHuronEvap_A[i, n], miHuronEvap_A[i, n]),
          col = colorVector[n - 2],
          lwd = 1.5,
          type = 's'
        )
        
        modelSkillPoints[[paste0('miHuronEvap', miHuronEvapSrc[n - 2])]] = c(modelSkillPoints[[paste0('miHuronEvap', miHuronEvapSrc[n -
                                                                                                                                      2])]],
    ...
    for (i in startMo:endMo) {
      ...
      for (n in 3:ncol(miHuronRunoff_A)) {
        lines(
          c(i, i + 1),
          c(miHuronRunoff_A[i, n], miHuronRunoff_A[i, n]),
          col = colorVector[n - 2],
          lwd = 1.5,
          type = 's'
        )
        
        modelSkillPoints[[paste0('miHuronRunoff', miHuronRunoffSrc[n - 2])]] = c(modelSkillPoints[[paste0('miHuronRunoff', miHuronRunoffSrc[n -
                                                                                                                                              2])]],
    ...
    for (i in startMo:endMo) {
      ...
      for (n in 3:ncol(miHuronNBS_A)) {
        lines(
          c(i, i + 1),
          c(miHuronNBS_A[i, n], miHuronNBS_A[i, n]),
          col = colorVector[n - 2],
          lwd = 1.5,
          type = 's'
        )
        
        modelSkillPoints[[paste0('miHuronNBS', miHuronNBSSrc[n - 2])]] = c(modelSkillPoints[[paste0('miHuronNBS', miHuronNBSSrc[n -
                                                                                                                                  2])]],
  ...
  for (i in startMo:endMo) {
    ...
    for (n in 3:ncol(miHuronOutflow_A)) {
      lines(
        c(i, i + 1),
        c(miHuronOutflow_A[i, n], miHuronOutflow_A[i, n]),
        col = colorVector[n - 2],
        lwd = 1.5,
        type = 's'
      )
      
      modelSkillPoints[[paste0('miHuronOutflow', miHuronOutflowSrc[n - 2])]] = c(modelSkillPoints[[paste0('miHuronOutflow', miHuronOutflowSrc[n -
                                                                                                                                                2])]],
  ...
  for (i in startMo:endMo) {
    ...
    for (n in 3:ncol(miHuronDiversion_A)) {
      lines(
        c(i, i + 1),
        c(miHuronDiversion_A[i, n], miHuronDiversion_A[i, n]),
        col = colorVector[n - 2],
        lwd = 1.5,
        type = 's'
      )
      
      modelSkillPoints[[paste0('miHuronDiversion', miHuronDiversionSrc[n - 2])]] = c(modelSkillPoints[[paste0('miHuronDiversion', miHuronDiversionSrc[n -
                                                                                                                                                        2])]],
  ...
  for (i in startMo:endMo) {
    ...
    lines(
      c(i, i + 1),
      c(miHuronDS_A[i, 3], miHuronDS_A[i, 3]),
      col = "goldenrod",
      lwd = 1.5,
      type = 's'
    )
  ...
  pdf(
    paste('clair_ALL_d', decade, '_', modelName, '.pdf', sep = ''),
    width = 10,
    height = 7.5
  )
  ...
  if (clairComponentWBM) {
    ...
    for (i in startMo:endMo) {
      ...
      for (n in 3:ncol(clairPrecip_A)) {
        lines(
          c(i, i + 1),
          c(clairPrecip_A[i, n], clairPrecip_A[i, n]),
          col = colorVector[n - 2],
          lwd = 1.5,
          type = 's'
        )
        
        modelSkillPoints[[paste0('clairPrecip', clairPrecipSrc[n - 2])]] = c(modelSkillPoints[[paste0('clairPrecip', clairPrecipSrc[n -
                                                                                                                                      2])]],
    ...
    for (i in startMo:endMo) {
      ...
      for (n in 3:ncol(clairEvap_A)) {
        lines(
          c(i, i + 1),
          c(clairEvap_A[i, n], clairEvap_A[i, n]),
          col = colorVector[n - 2],
          lwd = 1.5,
          type = 's'
        )
        
        modelSkillPoints[[paste0('clairEvap', clairEvapSrc[n - 2])]] = c(modelSkillPoints[[paste0('clairEvap', clairEvapSrc[n -
                                                                                                                              2])]],
    ...
    for (i in startMo:endMo) {
      ...
      for (n in 3:ncol(clairRunoff_A)) {
        lines(
          c(i, i + 1),
          c(clairRunoff_A[i, n], clairRunoff_A[i, n]),
          col = colorVector[n - 2],
          lwd = 1.5,
          type = 's'
        )
        
        modelSkillPoints[[paste0('clairRunoff', clairRunoffSrc[n - 2])]] = c(modelSkillPoints[[paste0('clairRunoff', clairRunoffSrc[n -
                                                                                                                                      2])]],
    ...
    for (i in startMo:endMo) {
      ...
      for (n in 3:ncol(clairNBS_A)) {
        lines(
          c(i, i + 1),
          c(clairNBS_A[i, n], clairNBS_A[i, n]),
          col = colorVector[n - 2],
          lwd = 1.5,
          type = 's'
        )
        
        modelSkillPoints[[paste0('clairNBS', clairNBSSrc[n - 2])]] = c(modelSkillPoints[[paste0('clairNBS', clairNBSSrc[n -
                                                                                                                          2])]],
  ...
  for (i in startMo:endMo) {
    ...
    for (n in 3:ncol(clairOutflow_A)) {
      lines(
        c(i, i + 1),
        c(clairOutflow_A[i, n], clairOutflow_A[i, n]),
        col = colorVector[n - 2],
        lwd = 1.5,
        type = 's'
      )
      
      modelSkillPoints[[paste0('clairOutflow', clairOutflowSrc[n - 2])]] = c(modelSkillPoints[[paste0('clairOutflow', clairOutflowSrc[n -
                                                                                                                                        2])]],
  ...
  pdf(
    paste('erieTS_ALL_d', decade, '_', modelName, '.pdf', sep = ''),
    width = 10,
    height = 7.5
  )
  ...
  if (erieComponentWBM) {
    ...
    for (i in startMo:endMo) {
      ...
      for (n in 3:ncol(eriePrecip_A)) {
        lines(
          c(i, i + 1),
          c(eriePrecip_A[i, n], eriePrecip_A[i, n]),
          col = colorVector[n - 2],
          lwd = 1.5,
          type = 's'
        )
        
        modelSkillPoints[[paste0('eriePrecip', eriePrecipSrc[n - 2])]] = c(modelSkillPoints[[paste0('eriePrecip', eriePrecipSrc[n -
                                                                                                                                  2])]],
    ...
    for (i in startMo:endMo) {
      ...
      for (n in 3:ncol(erieEvap_A)) {
        lines(
          c(i, i + 1),
          c(erieEvap_A[i, n], erieEvap_A[i, n]),
          col = colorVector[n - 2],
          lwd = 1.5,
          type = 's'
        )
        
        modelSkillPoints[[paste0('erieEvap', erieEvapSrc[n - 2])]] = c(modelSkillPoints[[paste0('erieEvap', erieEvapSrc[n -
                                                                                                                          2])]],
    ...
    for (i in startMo:endMo) {
      ...
      for (n in 3:ncol(erieRunoff_A)) {
        lines(
          c(i, i + 1),
          c(erieRunoff_A[i, n], erieRunoff_A[i, n]),
          col = colorVector[n - 2],
          lwd = 1.5,
          type = 's'
        )
        
        modelSkillPoints[[paste0('erieRunoff', erieRunoffSrc[n - 2])]] = c(modelSkillPoints[[paste0('erieRunoff', erieRunoffSrc[n -
                                                                                                                                  2])]],
    ...
    for (i in startMo:endMo) {
      ...
      for (n in 3:ncol(erieNBS_A)) {
        lines(
          c(i, i + 1),
          c(erieNBS_A[i, n], erieNBS_A[i, n]),
          col = colorVector[n - 2],
          lwd = 1.5,
          type = 's'
        )
        
        modelSkillPoints[[paste0('erieNBS', erieNBSSrc[n - 2])]] = c(modelSkillPoints[[paste0('erieNBS', erieNBSSrc[n -
                                                                                                                      2])]],
  ...
  for (i in startMo:endMo) {
    ...
    for (n in 3:ncol(erieOutflow_A)) {
      lines(
        c(i, i + 1),
        c(erieOutflow_A[i, n], erieOutflow_A[i, n]),
        col = colorVector[n - 2],
        lwd = 1.5,
        type = 's'
      )
      
      modelSkillPoints[[paste0('erieOutflow', erieOutflowSrc[n - 2])]] = c(modelSkillPoints[[paste0('erieOutflow', erieOutflowSrc[n -
                                                                                                                                    2])]],
  ...
  for (i in startMo:endMo) {
    ...
    for (n in 3:ncol(erieDiversion_A)) {
      lines(
        c(i, i + 1),
        c(erieDiversion_A[i, n], erieDiversion_A[i, n]),
        col = colorVector[n - 2],
        lwd = 1.5,
        type = 's'
      )
      
      modelSkillPoints[[paste0('erieDiversion', erieDiversionSrc[n - 2])]] = c(modelSkillPoints[[paste0('erieDiversion', erieDiversionSrc[n -
                                                                                                                                            2])]],
  ...
  pdf(
    paste('ontarioTS_ALL_d', decade, '_', modelName, '.pdf', sep = ''),
    width = 10,
    height = 7.5
  )
  ...
  if (ontarioComponentWBM) {
    ...
    for (i in startMo:endMo) {
      ...
      for (n in 3:ncol(ontarioPrecip_A)) {
        lines(
          c(i, i + 1),
          c(ontarioPrecip_A[i, n], ontarioPrecip_A[i, n]),
          col = colorVector[n - 2],
          lwd = 1.5,
          type = 's'
        )
        
        modelSkillPoints[[paste0('ontarioPrecip', ontarioPrecipSrc[n - 2])]] = c(modelSkillPoints[[paste0('ontarioPrecip', ontarioPrecipSrc[n -
                                                                                                                                              2])]],
    ...
    for (i in startMo:endMo) {
      ...
      for (n in 3:ncol(ontarioEvap_A)) {
        lines(
          c(i, i + 1),
          c(ontarioEvap_A[i, n], ontarioEvap_A[i, n]),
          col = colorVector[n - 2],
          lwd = 1.5,
          type = 's'
        )
        
        modelSkillPoints[[paste0('ontarioEvap', ontarioEvapSrc[n - 2])]] = c(modelSkillPoints[[paste0('ontarioEvap', ontarioEvapSrc[n -
                                                                                                                                      2])]],
    ...
    for (i in startMo:endMo) {
      ...
      for (n in 3:ncol(ontarioRunoff_A)) {
        lines(
          c(i, i + 1),
          c(ontarioRunoff_A[i, n], ontarioRunoff_A[i, n]),
          col = colorVector[n - 2],
          lwd = 1.5,
          type = 's'
        )
        
        modelSkillPoints[[paste0('ontarioRunoff', ontarioRunoffSrc[n - 2])]] = c(modelSkillPoints[[paste0('ontarioRunoff', ontarioRunoffSrc[n -
                                                                                                                                              2])]],
    ...
    for (i in startMo:endMo) {
      ...
      for (n in 3:ncol(ontarioNBS_A)) {
        lines(
          c(i, i + 1),
          c(ontarioNBS_A[i, n], ontarioNBS_A[i, n]),
          col = colorVector[n - 2],
          lwd = 1.5,
          type = 's'
        )
        
        modelSkillPoints[[paste0('ontarioNBS', ontarioNBSSrc[n - 2])]] = c(modelSkillPoints[[paste0('ontarioNBS', ontarioNBSSrc[n -
                                                                                                                                  2])]],
  ...
  for (i in startMo:endMo) {
    ...
    for (n in 3:ncol(ontarioOutflow_A)) {
      lines(
        c(i, i + 1),
        c(ontarioOutflow_A[i, n], ontarioOutflow_A[i, n]),
        col = colorVector[n - 2],
        lwd = 1.5,
        type = 's'
      )
      
      modelSkillPoints[[paste0('ontarioOutflow', ontarioOutflowSrc[n - 2])]] = c(modelSkillPoints[[paste0('ontarioOutflow', ontarioOutflowSrc[n -
                                                                                                                                                2])]],
  ...
  for (i in startMo:endMo) {
    ...
    lines(
      c(i, i + 1),
      c(ontarioDS_A[i, 3], ontarioDS_A[i, 3]),
      col = "goldenrod",
      lwd = 1.5,
      type = 's'
    )
...
for (mdi in 1:length(modelSkillPoints)) {
  hist(modelSkillPoints[[names(modelSkillPoints)[mdi]]],
...
superiorPrecipListing = modelListing[grepl('superiorPrecip', modelListing, fixed =
                                             TRUE)]
superiorEvapListing = modelListing[grepl('superiorEvap', modelListing, fixed =
                                           TRUE)]
superiorRunoffListing = modelListing[grepl('superiorRunoff', modelListing, fixed =
                                             TRUE)]

miHuronPrecipListing = modelListing[grepl('miHuronPrecip', modelListing, fixed =
                                            TRUE)]
miHuronEvapListing = modelListing[grepl('miHuronEvap', modelListing, fixed =
                                          TRUE)]
miHuronRunoffListing = modelListing[grepl('miHuronRunoff', modelListing, fixed =
                                            TRUE)]

eriePrecipListing = modelListing[grepl('eriePrecip', modelListing, fixed =
                                         TRUE)]
erieEvapListing = modelListing[grepl('erieEvap', modelListing, fixed = TRUE)]
erieRunoffListing = modelListing[grepl('erieRunoff', modelListing, fixed =
                                         TRUE)]

ontarioPrecipListing = modelListing[grepl('ontarioPrecip', modelListing, fixed =
                                            TRUE)]
ontarioEvapListing = modelListing[grepl('ontarioEvap', modelListing, fixed =
                                          TRUE)]
ontarioRunoffListing = modelListing[grepl('ontarioRunoff', modelListing, fixed =
                                            TRUE)]
...
pdf("model_skill_hists_precip.pdf",
    width = 7.5,
    height = 10)
...
for (mdi in 1:length(superiorPrecipListing)) {
  hist(
    ...
    main = gsub('superiorPrecip', '', superiorPrecipListing[mdi], fixed =
                  TRUE),
    col = 'dodgerblue2',
    border = 'dodgerblue4',
    ylab = '',
...
for (mdi in 1:length(miHuronPrecipListing)) {
  hist(
    ...
    main = gsub('miHuronPrecip', '', miHuronPrecipListing[mdi], fixed = TRUE),
    col = 'dodgerblue2',
    border = 'dodgerblue4',
    ylab = '',
    cex.main = 0.75,
...
for (mdi in 1:length(eriePrecipListing)) {
  hist(
    ...
    main = gsub('eriePrecip', '', eriePrecipListing[mdi], fixed = TRUE),
    col = 'dodgerblue2',
    border = 'dodgerblue4',
    ylab = '',
    cex.main = 0.75,
...
for (mdi in 1:length(ontarioPrecipListing)) {
  hist(
    ...
    main = gsub('ontarioPrecip', '', ontarioPrecipListing[mdi], fixed = TRUE),
    col = 'dodgerblue2',
    border = 'dodgerblue4',
    ylab = '',
    cex.main = 0.75,
...
pdf("model_skill_hists_evap.pdf",
    width = 7.5,
    height = 10)
...
for (mdi in 1:length(superiorEvapListing)) {
  hist(
    ...
    main = gsub('superiorEvap', '', superiorEvapListing[mdi], fixed = TRUE),
    col = 'dodgerblue2',
    border = 'dodgerblue4',
    ylab = '',
    cex.main = 0.75,
...
for (mdi in 1:length(miHuronEvapListing)) {
  hist(
    ...
    main = gsub('miHuronEvap', '', miHuronEvapListing[mdi], fixed = TRUE),
    col = 'dodgerblue2',
    border = 'dodgerblue4',
    ylab = '',
    cex.main = 0.75,
...
for (mdi in 1:length(erieEvapListing)) {
  hist(
    ...
    main = gsub('erieEvap', '', erieEvapListing[mdi], fixed = TRUE),
    col = 'dodgerblue2',
    border = 'dodgerblue4',
    ylab = '',
    cex.main = 0.75,
...
for (mdi in 1:length(ontarioEvapListing)) {
  hist(
    ...
    main = gsub('ontarioEvap', '', ontarioEvapListing[mdi], fixed = TRUE),
    col = 'dodgerblue2',
    border = 'dodgerblue4',
    ylab = '',
    cex.main = 0.75,
...
pdf("model_skill_hists_runoff.pdf",
    width = 7.5,
    height = 10)
...
for (mdi in 1:length(superiorRunoffListing)) {
  hist(
    ...
    main = gsub('superiorRunoff', '', superiorRunoffListing[mdi], fixed =
                  TRUE),
    col = 'dodgerblue2',
    border = 'dodgerblue4',
    ylab = '',
...
for (mdi in 1:length(miHuronRunoffListing)) {
  hist(
    ...
    main = gsub('miHuronRunoff', '', miHuronRunoffListing[mdi], fixed = TRUE),
    col = 'dodgerblue2',
    border = 'dodgerblue4',
    ylab = '',
    cex.main = 0.75,
...
for (mdi in 1:length(erieRunoffListing)) {
  hist(
    ...
    main = gsub('erieRunoff', '', erieRunoffListing[mdi], fixed = TRUE),
    col = 'dodgerblue2',
    border = 'dodgerblue4',
    ylab = '',
    cex.main = 0.75,
...
for (mdi in 1:length(ontarioRunoffListing)) {
  hist(
    ...
    main = gsub('ontarioRunoff', '', ontarioRunoffListing[mdi], fixed = TRUE),
    col = 'dodgerblue2',
    border = 'dodgerblue4',
    ylab = '',
    cex.main = 0.75,
...
for (mdi in 1:length(modelSkillPoints)) {
  for (mt in 1:12) {
    meanModelSkillPVals[names(modelSkillPoints)[mdi], mt] =
      mean(modelSkillPoints[[names(modelSkillPoints)[mdi]]][m == mt],
           na.rm = TRUE)
  }
}
